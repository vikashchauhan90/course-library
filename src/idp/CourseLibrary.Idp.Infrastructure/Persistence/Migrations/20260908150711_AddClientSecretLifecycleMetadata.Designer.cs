...
namespace CourseLibrary.Idp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908150711_AddClientSecretLifecycleMetadata")]
    partial class AddClientSecretLifecycleMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseLibrary.Idp.Domain.Entities.OpenIddictApplication", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("SecretCreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("secret_created_at");

                    b.Property<DateTimeOffset?>("SecretExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("secret_expires_at");
                    ...
                    b.HasIndex("SecretExpiresAt")
                        .HasDatabaseName("ix_applications_secret_expires_at");
            ...
            modelBuilder.Entity("CourseLibrary.Idp.Domain.Entities.Permission", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
            ...
            modelBuilder.Entity("CourseLibrary.Idp.Domain.Entities.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("CourseLibrary.Idp.Domain.Entities.RolePermission", b =>
                {
                    b.HasOne("CourseLibrary.Idp.Domain.Entities.Permission", "Permission")
                    ...
                    b.HasOne("CourseLibrary.Idp.Domain.Entities.ApplicationRole", "Role")
                        .WithMany("RolePermissions")
