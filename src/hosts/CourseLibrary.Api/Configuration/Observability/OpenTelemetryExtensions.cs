...
namespace CourseLibrary.Api.Configuration.Observability;
...
internal static class OpenTelemetryExtensions
{
        ...
        this WebApplicationBuilder builder)
    {
        ...
        builder.Services.TryAddSingleton<ApiObservability.Traces.Processors.ApplicationActivityProcessor>();
        ...
        builder.Services.AddOpenTelemetry()
             ...
             .WithTracing(tracing =>
             {
                 tracing
                     ...
                     .AddSource(ApiObservability.Traces.ActivitySources.Api.Name)
                     ...
                     .AddProcessor<ApiObservability.Traces.Processors.ApplicationActivityProcessor>();
             })
             .WithMetrics(metrics =>
             {
                 metrics
