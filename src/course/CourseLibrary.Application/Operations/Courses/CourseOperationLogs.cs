...
internal static partial class CourseOperationLogs
{
    ...
    public static partial void PersistingCourse(this ILogger logger, CourseId courseId, AuthorId authorId);

    [LoggerMessage(EventId = EventIds.Courses.UpdateCourse + 20, Level = LogLevel.Information, Message = "Updating course {CourseId}")]
    public static partial void UpdatingCourse(this ILogger logger, CourseId courseId);

    [LoggerMessage(EventId = EventIds.Courses.DeleteCourse + 20, Level = LogLevel.Information, Message = "Deleting course {CourseId}")]
    public static partial void DeletingCourse(this ILogger logger, CourseId courseId);
    ...
    public static partial void CourseNotFoundForDeletion(this ILogger logger, CourseId courseId);

    [LoggerMessage(EventId = EventIds.Courses.DeleteCourse + 22, Level = LogLevel.Information, Message = "Retiring course {CourseId}")]
    public static partial void RetiringCourse(this ILogger logger, CourseId courseId);
    ...
    public static partial void CourseNotFoundForRetirement(this ILogger logger, CourseId courseId);

    [LoggerMessage(EventId = EventIds.Courses.CreateCourse + 24, Level = LogLevel.Information, Message = "Course {CourseId} and {Action}")]
    public static partial void CourseEvent(this ILogger logger, CourseId courseId, CourseEventType action);
    ...
    public static partial void CreatingCourseAudit(this ILogger logger, CourseId courseId, CourseEventType Action);
    ...
    public static partial void CreatedCourseAudit(this ILogger logger, CourseId courseId, CourseEventType Action);
